...
set releaseFile=PSBD-projekt.pdf
...
rem tworzenie pdf z kodem projektu
cd sql_code
call make_pdf.bat
cd ..

rem powrót do roota projektu
move sql_code\sql_code.pdf kod_sql.pdf

call build_functions_only.bat